(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[179], {
        ...
        class $ {
            ...
            change(e, t, r, o, i) {
                ...
                return n(function*() {
                    ...
                    let W = q || o._shouldResolveHref || P.parsePath(t).pathname === P.parsePath(r).pathname
                      , z = a({}, d.state)
                      , G = !0 !== d.isReady;
                    d.isReady = !0;
                    let V = d.isSsr;
                    ...
                    d._inFlightRoute && d.clc && (V || $.events.emit("routeChangeError", k(), d._inFlightRoute, Q),
                    d.clc(),
                    d.clc = null),
                    ...
                    if (!q && d.onlyAHashChange(ee) && !et) {
                        ...
                        try {
                            ...
                            throw c.default(e) && e.cancelled && $.events.emit("routeChangeError", e, ee, Q),
                            e
                        }
                        return $.events.emit("hashChangeComplete", r, Q),
                        !0
                    }
                    ...
                    try {
                        [B,{__rewrites: U}] = yield Promise.all([d.pageLoader.getPageList(), s.getClientBuildManifest(), d.pageLoader.getMiddleware()])
                    } catch (e) {
                        return X({
                            url: r,
                            router: d
                    ...
                    if (q && eu && (W = !1),
                    W && "/_error" !== en && (o._shouldResolveHref = !0,
                    er.pathname = F(en, B),
                    ...
                    if (m.isDynamicRoute(ei)) {
                        ...
                        if (ec && (!o || i.result))
                            ...
                            if (e.length > 0 && !eu)
                                throw Error((o ? "The provided `href` (".concat(t, ") value is missing query values (").concat(e.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(n, ") is incompatible with the `href` value (").concat(ei, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(o ? "href-interpolation-failed" : "incompatible-href-as"))
                        }
                    }
                    ...
                    try {
                        ...
                        if (q || o.shallow || (yield d._bfl(r, "resolvedAs"in n ? n.resolvedAs : void 0, z.locale)),
                        "route"in n && eu) {
                            ei = en = n.route || ei,
                        ...
                        if ((n.__N_SSG || n.__N_SSP) && n.props) {
                            ...
                            if (z.isPreview = !!n.props.__N_PREVIEW,
                            n.props.notFound === Z) {
                                let e;
                                try {
                        ...
                        q && "/_error" === d.pathname && (null == (f = self.__NEXT_DATA__.props) ? void 0 : null == (p = f.pageProps) ? void 0 : p.statusCode) === 500 && (null == (j = n.props) ? void 0 : j.pageProps) && (n.props.pageProps.statusCode = 500);
                        ...
                        if (!S) {
                            ...
                            if (n.error)
                                throw q || $.events.emit("routeChangeError", n.error, ee, Q),
                                n.error;
            ...
            prefetch(e) {
                ...
                return n(function*() {
                    ...
                    m.isDynamicRoute(n.pathname) && (s = n.pathname,
                    n.pathname = s,
                    Object.assign(u, y.getRouteMatcher(v.getRouteRegex(n.pathname))(P.parsePath(t).pathname) || {}),
    ...
    6373: function(e, t, r) {
        ...
        t.getNextPathnameInfo = function(e, t) {
            ...
            if (s && o.pathHasPrefix(d.pathname, s) && (d.pathname = a.removePathPrefix(d.pathname, s),
            d.basePath = s),
            !0 === t.parseData && d.pathname.startsWith("/_next/data/") && d.pathname.endsWith(".json")) {
                let e = d.pathname.replace(/^\/_next\/data\//, "").replace(/\.json$/, "").split("/")
                  , t = e[0];
                d.pathname = "index" !== e[1] ? "/".concat(e.slice(1).join("/")) : "/",
                d.buildId = t
            }
            if (t.i18nProvider) {
                ...
                namedParameterizedRoute: s.map(e => {
                        ...
                        return "/".concat(a.escapeStringRegexp(e));
                    {
                        let {key: r, optional: n, repeat: a} = l(e.slice(1, -1))
                          , o = r.replace(/\W/g, "")
                          , s = !1;
                        return (0 === o.length || o.length > 30) && (s = !0),
                        isNaN(parseInt(o.slice(0, 1))) || (s = !0),
                        s && (o = u()),
                        t ? c[o = "".concat(i).concat(o)] = "".concat(i).concat(r) : c[o] = "".concat(r),
                        a ? n ? "(?:/(?<".concat(o, ">.+?))?") : "/(?<".concat(o, ">.+?)") : "/(?<".concat(o, ">[^/]+?)")
                    }
                }
                ).join(""),
                routeKeys: c
